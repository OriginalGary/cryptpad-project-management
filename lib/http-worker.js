...
const gzipStatic = require('connect-gzip-static').default || require('connect-gzip-static');
...
// Express 5+ removed express.static.mime; mime-types already handles wasm natively
